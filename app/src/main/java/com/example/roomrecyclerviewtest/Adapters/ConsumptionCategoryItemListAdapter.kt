...
class ConsumptionCategoryItemListAdapter (val context: Context,
                                          var itemList: List<ConsumptionCategory>
    ...
    private var calback: OnConsumptionCategoryClickListener? = null

    fun attachCalback(calback: OnConsumptionCategoryClickListener) {
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val viewHolder = CategoryItemConsumptionViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.consumption_category_item, parent, false))
        return viewHolder
//
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as CategoryItemConsumptionViewHolder).bindViews(itemList[position])

        holder.itemView.setOnClickListener{calback?.onConsumptionCategoryClick(itemList[position])}
